...
public final class Bindings {
	...
	public static final class BindingCondition implements Property<Boolean> {
		...
		public void setBase(Boolean value) {
			throw new UnsupportedOperationException("setBase");
		}
		 ...
		 */
		@Override
		public DriverSystem<Boolean> getDriver() {
			throw new UnsupportedOperationException("getDriver");
		}
		 ...
		 * {@inheritDoc}
		 * <p>
		 * For the conditional implementation, this also clones the
		 * boolean property from which this inverse is based.
		 */
		@Override
		public BindingCondition clone() {
			return new BindingCondition(condition.clone());
		}
		...
		public java.io.Serializable getUserPointer() {
			throw new UnsupportedOperationException("getUserPointer");
		}
		...
		public void setUserPointer(java.io.Serializable userPtr) {
			throw new UnsupportedOperationException("setUserPointer");
		}
	...
	public static final class PropertyBinding<T> implements Property<T> {
		...
		/**
		 * Creates a new property given the values.
		 */
		private PropertyBinding(BindingCondition condition, T whenTrue, T whenFalse) {
			this.condition = condition;
		...
		public Class<T> getPropertyType() {
			if(whenTrue != null) return (Class<T>) whenTrue.getClass();
			else if(whenFalse != null) return (Class<T>) whenFalse.getClass();
			else return null;
		}
		 ...
		 */
		@Override
		public PropertyBinding<T> clone() {
			return new PropertyBinding<T>(this.condition, this.whenTrue, this.whenFalse);
		}
