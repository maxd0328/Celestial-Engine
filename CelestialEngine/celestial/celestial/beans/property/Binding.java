...
public final class Binding<T> implements java.io.Serializable {
	 ...
	 * Package-level constructor.
	 * <p>
	 * Creates a new binding given a previous binding as well as a
	 * new root property.
	 * 
	 * @param src	The previous binding to construct this from.
	 * @param root	The root property to attach to this binding.
	 */
	Binding(Binding<T> src, Property<T> root) {
		this.root = root;
		this.guest = src.guest;
		this.order = src.order;
		this.rootOld = src.rootOld;
		this.guestOld = src.guestOld;
	}
	 ...
	 */
	public synchronized Property<T> getRoot() {
		return root;
	}
	 ...
	 */
	public synchronized Property<T> getGuest() {
		return guest;
	}
