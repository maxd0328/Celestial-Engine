...
public abstract class ObservableMap<K, V> extends ObservableImpl<Map<K, V>> implements Map<K, V> {
	...
	/**
	 * Returns the current index of the set containing
	 * the given key. NOTE: This may have undefined
	 * results when using unordered maps.
	 * <p>
	 * If the key is not found, {@code -1} is returned.
	 * 
	 * @param value	The key to locate
	 * @return		The index of that key's mapping
	 */
